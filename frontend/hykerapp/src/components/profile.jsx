...
export default function Profile() {
    ...
    return(
        <div className="min-h-screen bg-gradient-to-br from-[#4b0226] via-[#7b1742] to-[#f9f2e8] flex flex-col">
            <Navbar/>
            {/* main two-column area: left white box + right profile card */}
            <div className="w-full max-w-5xl mx-auto mt-8 px-4">
                <div className="grid md:grid-cols-2 gap-6">
                    {/* left: profile/avatar card */}
                    <div className="bg-[#f9f2e8] flex flex-col items-center justify-center p-8 rounded-lg space-y-4 relative">
                        {/* Avatar */}
                    ...
                    {/* right: stats and fun facts */}
                    <div className="bg-[#f9f2e8] rounded-3xl shadow-2xl overflow-hidden p-6">
