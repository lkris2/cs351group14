...
export default function Profile() {
    // load bundled avatar images from src/assets named personXX.png (Vite import)
    ...
    function handleFileChange(e) {
        ...
        setPickerOpen(false);
        // optional: you could upload this file to server here
    }

    return(
        <div className="min-h-screen bg-gradient-to-br from-[#4b0226] via-[#7b1742] to-[#f9f2e8] flex flex-col">
            <Navbar/>
            <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden"></div>
            <div className="w-full flex justify-start mt-8 px-4">
                <div className="w-full max-w-3xl bg-[#f9f2e8] flex flex-col items-center justify-center p-8 rounded-lg space-y-4 relative">
                    {/* Avatar */}
                    <div className="flex flex-col items-center w-full gap-4">
                        ...
                        <div className="text-center">
                            <p className="text-md tracking-[0.25em] uppercase text-pink-900/70 mb-0">
                                USER'S NAME
                            </p>
